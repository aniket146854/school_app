...
class noticeDescription extends StatelessWidget {
  String index, subject, sender, description;
  List<String> sendto;
  noticeDescription({Key key, @required this.index, @required this.sendto, @required this.description, @required this.sender, @required this.subject}) : super(key: key);
                    ...
                    children:<Widget>[
                      ...
                      Row(
                        ...
                        children:<Widget>[
                          ...
                          Container(
                                margin: EdgeInsets.only(left: 5.0, top: 10.0),
                                child: ReadMoreText(getStringFromList(sendto)),
                            ),
    ...
    static String getStringFromList(List<String> sendto) {
      String mystring = "";
      for(int i = 0; i < sendto.length; i++) {
        mystring = mystring + sendto.elementAt(i);
